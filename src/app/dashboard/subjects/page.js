    ...
    <div className="p-0 space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm font-medium">Manage academic subjects and curriculum categories.</p>
        </div>
          ...
          <Table>
            <TableHeader className="bg-muted/30">
              <TableRow className="hover:bg-transparent border-t-0">
                ...
                <TableHead className="font-bold text-[10px] uppercase tracking-widest">Subject Info</TableHead>
            ...
            <TableBody>
              {loading ? (
                ...
                paginatedSubjects.map((subject, index) => (
                  <TableRow key={subject._id} className="hover:bg-muted/20 transition-colors group">
                    ...
                    <TableCell>
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          <span className="font-semibold text-sm leading-none">{subject.subjectName}</span>
        ...
        <CardFooter className="flex flex-col sm:flex-row items-center justify-between gap-4 py-4 bg-muted/5 border-t border-muted/20">
          <div className="flex items-center gap-4">
            <div className="text-xs text-muted-foreground font-medium border-r pr-4 border-muted-foreground/20">
              Showing <b>{paginatedSubjects.length}</b> of <b>{filteredSubjects.length}</b> Results
            </div>
